    ...
    <br>
        ...
        <el-row >
            <el-form-item label="您的姓名：" label-width="100">
                <el-input v-model="questionForm.proposer_name" placeholder="请输入您的姓名" style="width: 27.3vw" :disabled = "inputDisable"></el-input>
            </el-form-item>
            <div  margin-left="auto">
            <el-form-item label="电话号码：" label-width="100">
                <el-input v-model="questionForm.proposer_phone_number" placeholder="请输入您的电话号码" style="width: 27.3vw" :disabled = "inputDisable"></el-input>
            </el-form-item>
            </div>
        </el-row>
            <el-form-item label="反馈说明：" label-width="100">
                <el-input v-model="questionForm.question_texts" type="textarea" placeholder="请留下您的宝贵建议" style="width: 60vw" rows="8" :disabled = "inputDisable"></el-input>
            </el-form-item>
...
export default{
    ...
    setup() {
        ...
        function submitImg() {//上传函数，用于调用图片上传组件的上传函数
            if (UploadImg.value) {
    ...
    methods:{
      ...
      // 通过 ref 访问子组件并调用方法
            this.$refs.childRef.beginUploadImg();
            if(
            ...
            const submit_question = await submitQuestion(
                time_,
                name_,
                phone_,
                imgUrl_,
        ...
        ImgSelected(toBeUp){//检查是否有已选的待上传图片\
